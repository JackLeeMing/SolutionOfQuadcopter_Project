...
class Actor():
    ...
    def build_model(self):
      ...
      # adding hidden layers
        net = layers.Dense(units=200,kernel_regularizer=layers.regularizers.l2(1e-6),activation='relu')(states)
        net = layers.Dense(units=300,kernel_regularizer=layers.regularizers.l2(1e-6),activation='relu')(states)
...
class Critic:
    ...
    def build_model(self):
        ...
        net_states = layers.Dense(units=128, kernel_regularizer=layers.regularizers.l2(1e-6), activation='relu')(states)
        net_states = layers.Dense(units=200, kernel_regularizer=layers.regularizers.l2(1e-6), activation='relu')(states)

        # Add hidden layer(s) for action pathway
        net_actions = layers.Dense(units=128, kernel_regularizer=layers.regularizers.l2(1e-6), activation='relu')(actions)
        net_actions = layers.Dense(units=200, kernel_regularizer=layers.regularizers.l2(1e-6), activation='relu')(net_actions)
